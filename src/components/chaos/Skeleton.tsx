...
export function Skeleton({ className, variant = "shimmer", rounded = "lg" }: {
  className?: string;
  variant?: "shimmer" | "pulse";
  rounded?: "md" | "lg" | "xl" | "2xl" | "full";
}) {
  const radius = { md: "rounded-md", lg: "rounded-lg", xl: "rounded-xl", "2xl": "rounded-2xl", full: "rounded-full" }[rounded];
